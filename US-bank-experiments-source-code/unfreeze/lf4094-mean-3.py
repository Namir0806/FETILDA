...
class BERT_Arch(nn.Module):
    ...
    def forward(self, sent_id, mask, hist):
        ...
        df_xy["x"]=[x]
        df_xy["y"]=[y]
        df_xy.to_csv('xy_lf4094_'+str(max_length)+'_'+sec+'_'+bv+'_mean_ep5.csv')
...
mse_file = open('mse_lf4094_'+str(max_length)+'_'+sec+'_'+bv+'_mean.txt', "w")
mse_file.write(mse + "\n")
...
test_error.to_csv('error_lf4094_'+str(max_length)+'_'+sec+'_'+bv+'_mean.csv', index=False) 
'''
