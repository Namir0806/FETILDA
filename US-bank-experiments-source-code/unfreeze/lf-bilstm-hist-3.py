...
class BERT_Arch(nn.Module):
    ...
    def forward(self, sent_id, mask, hist):
        ...
        df_xy["x"]=[x]
        df_xy["y"]=[y]
        df_xy.to_csv('xy_lf_'+str(max_length)+'_'+sec+'_'+bv+'_bilstm_hist_ep5.csv')
...
mse_file = open('mse_lf_'+str(max_length)+'_'+sec+'_'+bv+'_bilstm_hist.txt', "w")
mse_file.write(mse + "\n")
...
test_error.to_csv('error_lf_'+str(max_length)+'_'+sec+'_'+bv+'_bilstm_hist.csv', index=False)  
'''
